-- Check database existence and create it.
...
-- Set authorization to System Administrator.

Alter Authorization on Database::SeniorCare to sa;
Go
...
If not exists ( Select 1 From sys.tables Where Name = 'Medical.DiagnoseList' and Type = 'U')
Begin
...
If not exists ( Select 1 From sys.tables Where Name = 'Medical.PacientDiagnoses' and Type = 'U')
Begin
	Create Table Medical.PacientDiagnoses
		(
